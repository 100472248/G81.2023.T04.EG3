...
class MyTestCase(unittest.TestCase):
    ...
    def test_all_correct(self):
        ...
        value = my_order.register_order("8421691423220",
                                        "REGULAR",
    ...
    def test_ean13_not_number(self):
        ...
        my_order = OrderManager()
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("codigoean13",
                                    "REGULAR",
                                    "C/LISBOA, 4, MADRID, SPAIN",
                                    "123456789",
                                    "28005")
    ...
    def test_ean13_corto(self):
        ...
        my_order = OrderManager()
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("842169142322",
                                    "REGULAR",
                                    "C/LISBOA, 4, MADRID, SPAIN",
                                    "123456789",
                                    "28005")
    ...
    def test_ean13_largo(self):
        """..."""
        my_order = OrderManager()
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("84216914232256",
                                    "REGULAR",
                                    "C/LISBOA, 4, MADRID, SPAIN",
                                    "123456789",
                                    "28005")
    ...
    def test_not_check_sum(self):
        """..."""
        my_order = OrderManager()
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("8421691423229",
                                    "REGULAR",
                                    "C/LISBOA, 4, MADRID, SPAIN",
                                    "123456789",
                                    "28005")
    ...
    def test_address_too_long(self):
        ...
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("8421691423220",
                                    "PREMIUM",
                                    "AVENIDA VILLANUEVA DEL ARZOBISPO DE GUADALAJARA,102, "
    ...
    def test_vl7(self):
        ...
        value = my_order.register_order("8421691423220",
                                        "REGULAR",
                                        "AVENIDA VILLAVICIOSA DEL OBISPO DE GUADALAJARA,102, "
                                        "TORDESILLAS, VALLADOLID, CASTILLA Y LEON, SPAIN",
                                        "123456789",
                                        "28005")
    ...
    def test_zip_initials(self):
        ...
        my_order = OrderManager()
        with self.assertRaises(OrderManagementException) as invalido:
            my_order.register_order("8421691423220", "PREMIUM",
                                    "C/LISBOA, 4, MADRID, SPAIN",
                                    "123456789",
                                    "60005")
        self.assertEqual("Las dos cifras iniciales deben "
                         "estar entre 01 y 52", invalido.exception.message)
